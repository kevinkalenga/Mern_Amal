            ...
            <div className="flex flex-col flex-1 gap-4">
                     ...
                     <div className="flex gap-4">
                        ...
                        <button className="p-3 text-green-700
                         border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">Télecharger</button>
                     </div>
                     <button className="p-3 bg-slate-700 text-white rounded uppercase
                      hover:shadow-lg disabled:opacity-80">Créer une annonce</button>
            </div>
          </form>
    </main>
  )
